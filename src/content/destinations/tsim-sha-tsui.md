...
heroVideo: ""
heroImage: ""
tagline: "The Heart of Kowloon's Golden Mile"
region: kowloon
bestMonths:
  - October
  - November
...
budgetPerDay:
  ...
  midRange: 180
  luxury: 500
gettingThere: "MTR to Tsim Sha Tsui station (Tsuen Wan Line or East Tsim Sha Tsui on East Rail Line). Star Ferry from Central Pier 7 for the scenic 10-minute harbour crossing — HKD 3.40."
essentials:
  - icon: "🚇"
    label: "Getting There"
    value: "MTR Tsim Sha Tsui station (Tsuen Wan Line, Exit L6 for the waterfront). Star Ferry from Central Pier 7 (HKD 3.40, 10 min)."
  - icon: "⛴️"
    label: "Star Ferry"
    value: "Central Pier 7 to TST every 6-12 minutes. Last ferry around 11:30pm. Upper deck is HKD 4.50 — worth it for the view."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 300-800 ($38-100 USD) per person including meals, museums, and transport."
  - icon: "🌃"
    label: "Evening Activity"
    value: "Symphony of Lights runs free every night at 8pm from the Avenue of Stars waterfront."
highlights:
  - title: "Avenue of Stars Waterfront"
    icon: "⭐"
    image: ""
  - title: "Star Ferry Crossing"
    icon: "⛴️"
    image: ""
  - title: "Symphony of Lights Show"
    icon: "🌃"
    image: ""
  ...
  - title: "Temple Street Night Market"
    icon: "🏮"
    image: ""
gradientColors: "from-red-900 via-red-800 to-orange-700"
relatedDestinations:
  - mong-kok
  - central
  - victoria-peak
faqItems:
  - question: "What is the Symphony of Lights show?"
    answer: "The Symphony of Lights is a nightly multimedia show at 8pm featuring synchronized light, laser, and sound effects from 44 buildings on both sides of Victoria Harbour. It runs for 13 minutes and is completely free. Best viewed from the Avenue of Stars promenade in TST."
  - question: "Is the Star Ferry worth taking?"
    answer: "The Star Ferry is one of the great short journeys in the world and absolutely worth doing. The 10-minute crossing from Central Pier 7 to TST costs just HKD 3.40 and offers views of the Hong Kong Island skyline that no other mode of transport can match."
  - question: "How far is Tsim Sha Tsui from the airport?"
    answer: "About 30-35 minutes by MTR (Airport Express to Hong Kong Station, then transfer to Tsuen Wan Line). Many TST hotels also run airport shuttle services."
  - question: "What is the best hotel area in Tsim Sha Tsui?"
    answer: "Salisbury Road and the waterfront area near the Peninsula Hotel offer the best harbour views. The streets behind Nathan Road (Knutsford Terrace area) have excellent mid-range dining and bars. For budget travel, Chungking Mansions on Nathan Road is famous for cheap guesthouses."
  - question: "What can I do in Tsim Sha Tsui in one day?"
    answer: "Take the Star Ferry from Central, walk the Avenue of Stars waterfront, visit the Hong Kong Museum of History (2-3 hours), explore Kowloon Park, walk up Nathan Road to Mong Kok, then return for the 8pm Symphony of Lights. That fills a full day well."
  - question: "Where should I eat in Tsim Sha Tsui?"
    answer: "Nathan Road and the streets off it have everything from cheap cha chaan teng to upscale Cantonese restaurants. Knutsford Terrace (a pedestrian lane) has outdoor dining bars. The Peninsula Hotel lobby is famous for afternoon tea (HKD 400-600 per person, reservations essential)."
  - question: "Is Temple Street Night Market near Tsim Sha Tsui?"
...
affiliatePicks:
  - name: "Find Hotels in Tsim Sha Tsui"
    ...
    personalNote: "TST has everything from budget guesthouses (Chungking Mansions area) to the legendary Peninsula. Mid-range options on Mody Road or Cameron Road are good value with easy waterfront access."
    affiliateUrl: "https://www.booking.com/searchresults.html?ss=Tsim+Sha+Tsui+Hong+Kong&aid=2778866"
  - name: "Symphony of Lights Cruise (Klook)"
    type: "activity"
    price: "HKD 180-350"
