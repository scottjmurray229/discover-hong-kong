...
heroVideo: ""
heroImage: ""
tagline: "Hong Kong's Outdoor Playground and Seafood Capital"
...
budgetPerDay:
  ...
  midRange: 140
  luxury: 300
gettingThere: "MTR to Diamond Hill (Kwun Tong Line), then green minibus 1A or bus 92 to Sai Kung Town (25-30 min). Or MTR to Hang Hau (Tseung Kwan O Line) then bus 101. Total 50-70 min from Kowloon."
essentials:
  - icon: "🚌"
    label: "Getting There"
    value: "Green Minibus 1A from Diamond Hill MTR Exit C2 to Sai Kung Town (25 min, HKD 11). Bus 92 also runs the same route on weekdays."
  - icon: "⛵"
    label: "Island Access"
    value: "Kaito (licensed small ferry) from Sai Kung pier to Sharp Island and other outlying beaches. HKD 20-30 each way, last departure around 6pm."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 300-600 ($38-75 USD) per person. Waterfront seafood is the main expense — budget HKD 200-400 per person for a proper lunch."
  - icon: "🥾"
    label: "Hiking"
    value: "MacLehose Trail Stage 1 from Pak Tam Chung to Long Ke Wan (7km, 2.5 hours, moderate). Bring water and wear proper footwear."
highlights:
  - title: "MacLehose Trail Coastal Hike"
    icon: "🥾"
    image: ""
  - title: "Sai Kung Waterfront Seafood"
    icon: "🦞"
    image: ""
  - title: "High Island Reservoir Geopark"
    icon: "🪨"
    image: ""
  - title: "Sharp Island Kayaking"
    icon: "🚣"
    image: ""
  - title: "Hoi Ha Wan Marine Park"
    icon: "🐠"
    image: ""
  - title: "Sai Kung Country Park"
    icon: "🌿"
    image: ""
gradientColors: "from-emerald-900 via-green-800 to-teal-700"
relatedDestinations:
  - lamma-island
  - lantau-island
  - stanley
faqItems:
  - question: "What is the MacLehose Trail in Sai Kung?"
    answer: "The MacLehose Trail is a 100km hiking trail through the New Territories, starting in Sai Kung Country Park. Stage 1 (from Pak Tam Chung to Long Ke Wan, 10km, 4 hours, moderate) is the most popular section with dramatic coastal views, the High Island Reservoir, and access to remote beaches. It is one of Hong Kong's finest hikes."
  - question: "What is the High Island Reservoir Geopark?"
    answer: "The High Island Reservoir Geopark is a UNESCO Global Geopark featuring remarkable hexagonal volcanic rock columns — some up to 100 metres tall — rising from the sea like a giant natural causeway. The columns were formed about 140 million years ago by volcanic activity. Access is via the MacLehose Trail Stage 1 from Pak Tam Chung."
  - question: "How do I choose live seafood at Sai Kung waterfront?"
    answer: "Sai Kung's waterfront restaurants have tanks of live seafood outside. You choose your fish, prawns, lobster, or crab, and they cook it to order — usually steamed with ginger and spring onion, or salt and pepper fried. Prices are by weight. Ask the price before selecting to avoid surprises. HKD 150-400 per person is typical."
  - question: "How do I get to Sharp Island from Sai Kung?"
    answer: "Kaito (small licensed ferries) depart from the main Sai Kung pier to Sharp Island and other nearby beaches throughout the day. The crossing takes about 10 minutes and costs HKD 20-30 each way. The kaito schedule is informal — boats go when they have passengers. Last return is typically around 5-6pm."
  - question: "What is there to do at Sharp Island?"
    answer: "Sharp Island has clear water for swimming and snorkeling, and a tombolo — a sandbar connecting two land masses — that is exposed at low tide, creating a natural walkway. It is one of the most scenic spots accessible by day trip from Sai Kung. Bring snorkeling gear and sunscreen."
  - question: "How long does a Sai Kung day trip take?"
    answer: "Allow 8-10 hours for a full Sai Kung day. Budget 50-70 min travel from Kowloon, 2-4 hours hiking (MacLehose Stage 1), 1.5-2 hours for seafood lunch, and 1-2 hours on Sharp Island. Return travel adds another 50-70 min. Start by 8:30am."
  - question: "Is Hoi Ha Wan Marine Park worth visiting?"
