...
heroVideo: ""
heroImage: ""
tagline: "Seafood Village Life, No Cars, and Laid-Back Beaches"
...
budgetPerDay:
  ...
  midRange: 110
  luxury: 250
gettingThere: "Ferry from Central Pier 4 to Yung Shue Wan (25 min) or to Sok Kwu Wan (35 min). Multiple sailings daily from 6:30am. HKD 20-30 each way. Octopus card not accepted — buy ticket at the pier."
essentials:
  - icon: "⛴️"
    label: "Getting There"
    value: "Ferry from Central Pier 4 to Yung Shue Wan (25 min, HKD 20-30). Last ferry back to Central around 11:30pm. Check schedule at the pier."
  - icon: "🚶"
    label: "Getting Around"
    value: "Walk everywhere — no cars on Lamma Island. The Lamma Family Trail from Yung Shue Wan to Sok Kwu Wan takes about 1 hour on foot."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 200-450 ($25-57 USD) per person. Seafood lunch at Sok Kwu Wan is the main expense: HKD 120-300 per person."
  - icon: "🏖️"
    label: "Beach"
    value: "Hung Shing Ye Beach is the island's main beach, located midway on the Family Trail. Small, clean, and usually uncrowded on weekdays."
highlights:
  - title: "Yung Shue Wan Village"
    icon: "🏘️"
    image: ""
  - title: "Lamma Family Trail"
    icon: "🥾"
    image: ""
  - title: "Hung Shing Ye Beach"
    icon: "🏖️"
    image: ""
  - title: "Sok Kwu Wan Seafood Restaurants"
    icon: "🦐"
    image: ""
  - title: "Power Station Beach"
    icon: "⚡"
    image: ""
  - title: "Lo So Shing Beach"
    icon: "🌊"
    image: ""
gradientColors: "from-cyan-900 via-teal-800 to-emerald-700"
relatedDestinations:
  - lantau-island
  - tai-o
  - aberdeen
faqItems:
  - question: "How do I get to Lamma Island?"
    answer: "Take the ferry from Central Pier 4 to Yung Shue Wan (25 min, HKD 20-30) or to Sok Kwu Wan (35 min). Ferries run throughout the day from about 6:30am. Cash or card at the pier — Octopus card is not accepted. Last ferry back from Yung Shue Wan is around 11:30pm."
  - question: "What is the Lamma Family Trail?"
    answer: "The Lamma Family Trail is a 1-hour walk connecting Yung Shue Wan on the north coast to Sok Kwu Wan on the south coast via a forested ridgeline. The trail is easy (some steps) and passes Hung Shing Ye Beach at the midpoint. It gives a complete cross-section of the island. No vehicles anywhere."
  - question: "What is the best restaurant in Sok Kwu Wan?"
    answer: "All the seafood restaurants at Sok Kwu Wan have tables directly over the water and serve similar live seafood selections. Rainbow Restaurant and Lamma Hilton are long-established and both good. The real decision is what to order: steamed garoupa, typhoon shelter crab, baked lobster with cheese, or any of the fresh prawns from the tanks outside."
  - question: "What is Yung Shue Wan village like?"
    answer: "Yung Shue Wan is Lamma's main village — a small settlement of restaurants, cafes, art studios, a small wet market, and a few guesthouses. It has a distinctly bohemian character with a mix of long-term expat residents, Hong Kong locals, and weekend visitors. The main street has good cafes for breakfast before starting the trail."
  - question: "Is Hung Shing Ye Beach good for swimming?"
    answer: "Hung Shing Ye Beach is a small, sheltered sandy beach with calm water. It is good for a quiet swim with fewer people than the beaches closer to urban Hong Kong. The beach is about 30 minutes into the Family Trail from Yung Shue Wan. There are basic facilities including changing rooms. The power station at the north end of the beach is an unusual background."
  - question: "Can I do Lamma Island in a half day?"
    answer: "Yes — a half day is the standard visit. Take a late morning ferry to Yung Shue Wan, walk the Family Trail to Sok Kwu Wan (1 hour), have a long seafood lunch (1.5-2 hours), then take the ferry back to Central from Sok Kwu Wan. The two ferry piers are at opposite ends of the island, so you naturally do a one-way crossing."
  - question: "Are there accommodation options on Lamma Island?"
...
affiliatePicks:
  - name: "Find Guesthouses on Lamma Island"
    type: "hotel"
    price: "From HKD 400/night"
    personalNote: "Staying overnight on Lamma lets you experience the island without day-trip crowds. Book well in advance for weekends and public holidays."
    affiliateUrl: "https://www.booking.com/searchresults.html?ss=Lamma+Island+Hong+Kong&aid=2778866"
  - name: "Lamma Island Ferry and Food Tour (Klook)"
    type: "activity"
    price: "HKD 250-400"
