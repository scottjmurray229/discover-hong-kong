...
budgetPerDay:
  ...
  midRange: 120
  luxury: 300
gettingThere: "MTR Mong Kok station on Kwun Tong Line or Tsuen Wan Line. Walking distance north from Tsim Sha Tsui via Nathan Road — about 20 minutes on foot."
essentials:
  - icon: "🚇"
    label: "Getting There"
    value: "MTR Mong Kok station (Kwun Tong Line Exit B1 for Ladies Market, Tsuen Wan Line Exit E2 for Nathan Road markets)."
  - icon: "⏰"
    label: "Best Time"
    value: "Markets set up fully from 4-6pm. Come for dinner and evening shopping when the neon is at its best."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 100-400 ($13-50 USD) per person. Bargaining is expected and common at open-air stalls."
  - icon: "🚶"
    label: "Getting Around"
    value: "Walk — Mong Kok is dense and compact. All main markets are within a 15-minute walk of each other."
highlights:
  - title: "Ladies Market (Tung Choi Street)"
    icon: "👗"
    image: ""
  - title: "Flower Market Road"
    icon: "🌸"
    image: ""
  - title: "Goldfish Market"
    icon: "🐠"
    image: ""
  - title: "Bird Garden (Yuen Po Street)"
    icon: "🐦"
    image: ""
  - title: "Langham Place Mall"
    icon: "🛍️"
    image: ""
  - title: "Sneaker Street"
    icon: "👟"
    image: ""
gradientColors: "from-orange-900 via-red-800 to-rose-700"
relatedDestinations:
  - tsim-sha-tsui
  - stanley
  - causeway-bay
faqItems:
  - question: "What is Ladies Market in Mong Kok?"
    answer: "Ladies Market (Tung Choi Street) runs for several blocks and has over 100 stalls selling clothing, bags, accessories, toys, and souvenirs at bargain prices. Haggling is expected — start at 40-50% of the asking price. Open daily from about noon to midnight, busiest after 5pm."
  - question: "What are the opening hours for Mong Kok markets?"
    answer: "Ladies Market is open noon-midnight. Flower Market runs daily from early morning to 7pm (busiest on weekends). Goldfish Market is open roughly 10am-6pm. Bird Garden is open from 7am to about 7pm. Temple Street Night Market (nearby Jordan) opens from 5pm."
  - question: "Is Mong Kok safe at night?"
    answer: "Yes — Mong Kok is extremely safe. Hong Kong has one of the lowest violent crime rates in the world. The main concern is pickpocketing in very crowded market areas, so keep bags zipped and wallets secure."
  - question: "What should I buy at Mong Kok markets?"
    answer: "Ladies Market is best for casual clothing, phone accessories, and small souvenirs. Flower Market for fresh flowers and dried botanicals. Goldfish Market for unique aquarium fish (though transporting them home is difficult). The jade market near Yau Ma Tei is good for jewelry."
  - question: "How do I get from Mong Kok to Temple Street Night Market?"
    answer: "Temple Street is a 10-15 minute walk south down Nathan Road or one MTR stop south to Jordan station. Temple Street runs nightly from around 5pm and has fortune tellers, clothing stalls, and informal street food."
  - question: "What food should I try in Mong Kok?"
    answer: "Street snacks are the thing here: egg waffles (gai daan jai), curry fish balls, stinky tofu, and freshly squeezed sugar cane juice. Langham Place has good food courts for sit-down meals. Cha chaan tengs (Hong Kong-style cafes) along Sai Yeung Choi Street serve milk tea and egg toast breakfasts."
  - question: "What is the Goldfish Market and is it worth visiting?"
...
affiliatePicks:
  - name: "Find Hotels in Kowloon / Mong Kok"
    type: "hotel"
    price: "From HKD 500/night"
    personalNote: "Mong Kok has more affordable hotels than TST or Central, and MTR access is excellent. The Langham and Cordis are the area's upscale options."
    affiliateUrl: "https://www.booking.com/searchresults.html?ss=Mong+Kok+Hong+Kong&aid=2778866"
  - name: "Hong Kong Night Market Tour (Klook)"
    type: "tour"
    price: "HKD 250-450"
