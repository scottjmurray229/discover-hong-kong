...
budgetPerDay:
  ...
  midRange: 130
  luxury: 300
gettingThere: "Bus 6, 6A, or 260 from Exchange Square Central (30-40 min, HKD 7-10). Bus 73 from Aberdeen (20 min). No MTR — bus is the only public option."
essentials:
  - icon: "🚌"
    label: "Getting There"
    value: "Bus 6 or 260 from Exchange Square Bus Terminal, Central to Stanley (30-40 min, HKD 7-10). Sit on upper deck right side for mountain pass views."
  - icon: "🛍️"
    label: "Stanley Market"
    value: "Open daily approximately 9am-6pm. Best for silk scarves, casual clothing, paintings, and souvenirs. Prices negotiable."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 200-500 ($25-65 USD) per person. Waterfront bar-restaurants run HKD 120-200 per person for a casual lunch."
  - icon: "🏖️"
    label: "The Beach"
    value: "Stanley Main Beach is a small sheltered bay — better for a swim than serious beach time. Combine with a stroll to St. Stephen's Beach nearby."
highlights:
  - title: "Stanley Market"
    icon: "🛍️"
    image: ""
  - title: "Murray House Colonial Building"
    icon: "🏛️"
    image: ""
  - title: "Stanley Main Beach"
    icon: "🏖️"
    image: ""
  - title: "Tin Hau Temple"
    icon: "⛩️"
    image: ""
  - title: "Stanley Plaza Waterfront"
    icon: "🌊"
    image: ""
  - title: "Dragon's Back Hike Access"
    icon: "🥾"
    image: ""
gradientColors: "from-sky-900 via-blue-800 to-indigo-700"
relatedDestinations:
  - aberdeen
  - wan-chai
  - lamma-island
faqItems:
  - question: "What is Stanley Market and what can I buy there?"
    answer: "Stanley Market is an open-air covered market on a winding lane near the waterfront. It sells silk scarves, paintings, Chinese calligraphy, casual clothing, linen shirts, and tourist souvenirs. Quality varies — the silk scarves and paintings are the best buys. Bargaining is acceptable, especially for multiple purchases."
  - question: "What is Murray House in Stanley?"
    answer: "Murray House is a three-storey colonial building originally constructed in Central in 1844 as a military officers' mess. It was dismantled stone by stone in 1982 and reassembled in Stanley in 1998. It now houses restaurants and shops at Stanley Plaza and is one of the best-preserved Victorian-era colonial buildings in Hong Kong."
  - question: "How do I get to Stanley from Central?"
    answer: "Bus 6 or 260 from Exchange Square Bus Terminal in Central takes 30-40 minutes over the mountain pass. The scenic route over Wong Nai Chung Gap offers excellent views. Sit on the upper deck right-hand side going outbound. Bus 73 connects Aberdeen to Stanley in about 20 minutes."
  - question: "Is Stanley worth a full day?"
    answer: "Stanley suits a half-day combined with nearby attractions. Morning: market and Murray House (2 hours). Lunch at a waterfront bar-restaurant (1.5 hours). Then bus 73 to Aberdeen for the afternoon sampan tour. Alternatively, walk the 4km Dragon's Back trail that ends near Shek O for a full scenic day."
  - question: "What is the best beach near Stanley?"
    answer: "Stanley Main Beach is a small sheltered cove good for a quick swim. St. Stephen's Beach (10 min walk) is quieter and less crowded. For a longer beach, Repulse Bay (15 min by bus 73 towards Aberdeen) is the best on the south side — a long crescent with good facilities."
  - question: "What restaurants are good in Stanley?"
    answer: "The waterfront bar-restaurants at Stanley Main Street do decent burgers, fish and chips, and pub food with sea views. Classified (a wine bar and restaurant) is a step up in quality. The restaurants around Murray House have pleasant outdoor seating facing Stanley Bay."
  - question: "Is there hiking near Stanley?"
