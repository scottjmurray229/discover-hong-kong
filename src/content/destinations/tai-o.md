...
budgetPerDay:
  ...
  midRange: 100
  luxury: 200
gettingThere: "From Tung Chung: Bus 11 (40 minutes, HKD 6). From Mui Wo (Lantau ferry pier): Bus 1 (60 minutes). From Ngong Ping Big Buddha: Bus 21 (20 minutes). No direct route from urban Hong Kong — Tung Chung MTR is the practical starting point."
essentials:
  - icon: "🚌"
    label: "Getting There"
    value: "Bus 11 from Tung Chung Bus Terminal to Tai O (40 min, HKD 6). Buses every 30-45 minutes. Return on the same route."
  - icon: "⛵"
    label: "Pink Dolphin Tour"
    value: "Boat tours depart from the main pier bridge throughout the day. HKD 25-50 per person (20-30 min). Chinese White Dolphins are spotted frequently in the mornings."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 100-250 ($13-32 USD) per person. Tai O is one of Hong Kong's most affordable destinations — food is cheap and the main sights are free."
  - icon: "🏨"
    label: "Tai O Heritage Hotel"
    value: "Former colonial police station now a boutique hotel. The most atmospheric place to stay in Hong Kong. Book well in advance."
highlights:
  - title: "Stilt House Village"
    icon: "🏘️"
    image: ""
  - title: "Pink Dolphin Boat Tour"
    icon: "🐬"
    image: ""
  - title: "Shrimp Paste Markets"
    icon: "🦐"
    image: ""
  - title: "Tai O Heritage Hotel"
    icon: "🏛️"
    image: ""
  - title: "Kwan Tai Temple"
    icon: "⛩️"
    image: ""
  - title: "Tai O Egg Waffles"
    icon: "🧇"
    image: ""
gradientColors: "from-teal-900 via-cyan-800 to-blue-700"
relatedDestinations:
  - lantau-island
  - lamma-island
  - sai-kung
faqItems:
  - question: "What is Tai O famous for?"
    answer: "Tai O is famous for its traditional stilt house community built over tidal channels, its shrimp paste production (the fermented paste used throughout Cantonese cooking), and as the best location in Hong Kong to see Chinese White Dolphins (locally called pink dolphins). It is one of the last surviving examples of traditional Cantonese fishing village life."
  - question: "How do I get to Tai O?"
    answer: "Take the MTR Tung Chung Line to Tung Chung (end of line), then Bus 11 from Tung Chung Bus Terminal to Tai O (40 min, HKD 6). Buses run every 30-45 minutes. If combining with the Big Buddha, take the cable car to Ngong Ping then Bus 21 to Tai O (20 min)."
  - question: "Can I see pink dolphins at Tai O?"
    answer: "Chinese White Dolphins (which are actually pink in colour due to capillary blood vessels beneath the skin) live in the Pearl River estuary west of Lantau. Boat tours from Tai O pier offer the best chance of sightings. Morning tours (before 10am) have higher success rates. Sightings are frequent but not guaranteed — allow for the possibility of seeing none."
  - question: "What should I buy at Tai O?"
    answer: "Shrimp paste in earthenware pots is the traditional Tai O souvenir. Dried seafood — shrimp, fish, and scallops — is also sold throughout the village. Tai O egg waffles (gai daan jai) are a local version of the Hong Kong street snack. Small Tin Hau deity figures are sold at some of the temple supply shops."
  - question: "What is the Tai O Heritage Hotel?"
    answer: "The Tai O Heritage Hotel occupies the former Tai O Marine Police Station, a colonial building from 1902 on a small promontory with views across the channel. It was converted into a boutique hotel with 9 rooms after the police station closed in 2006. It is one of the most atmospheric and unique accommodation options in Hong Kong — book months in advance."
  - question: "How long should I spend in Tai O?"
    answer: "Allow 2-3 hours for a Tai O visit. The village is compact and easily walkable. Spend time at the main stilt house area over the channels, walk through the market streets, do a dolphin boat tour (30 min), try the local snacks, and visit Kwan Tai Temple. Combine with the Big Buddha for a full Lantau day."
  - question: "What is Kwan Tai Temple in Tai O?"
