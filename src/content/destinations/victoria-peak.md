...
heroVideo: ""
heroImage: ""
heroAlt: "Victoria Peak night panorama of Hong Kong's neon skyline and Victoria Harbour"
...
budgetPerDay:
  ...
  midRange: 150
  luxury: 400
gettingThere: "Take the Peak Tram from Lower Peak Tram Terminus on Garden Road — one of the world's oldest funiculars, running since 1888. Or take Bus 15 from Exchange Square, Central."
essentials:
  - icon: "🚃"
    label: "Getting There"
    value: "Peak Tram from Garden Road terminus (HKD 88 return). Bus 15 from Exchange Square (HKD 10). Taxi from Central ~HKD 70."
  - icon: "💰"
    label: "Daily Budget"
    value: "HKD 200-600 ($25-75 USD) per person including tram, Sky Terrace, and a meal."
  - icon: "🌅"
    label: "Best Time"
    value: "Arrive 30-45 min before sunset — golden hour views then city lights. Clear October-March days are best."
  - icon: "👟"
    label: "Getting Around"
    value: "Walk Lugard Road circular trail (3.5km, 45 min) around the peak — free and the best views."
highlights:
  - title: "Sky Terrace 428 Panorama"
    icon: "🌆"
    image: ""
  - title: "Peak Tram Historic Ride"
    icon: "🚃"
    image: ""
  - title: "Lugard Road Circular Hike"
    icon: "🥾"
    image: ""
  - title: "Victoria Peak Garden"
    icon: "🌿"
    image: ""
  - title: "Lion's Pavilion Viewpoint"
    icon: "🦁"
    image: ""
gradientColors: "from-purple-900 via-indigo-800 to-blue-900"
relatedDestinations:
  - central
  - wan-chai
  - stanley
faqItems:
  - question: "What is the best time to visit Victoria Peak?"
    answer: "October to March offers the clearest skies and lowest humidity. Arrive before sunset for golden hour views, then stay for the illuminated city at night. Avoid rainy days in summer (June-September) when visibility is poor."
  - question: "How do I get to Victoria Peak?"
    answer: "The Peak Tram from Garden Road (MTR Central, Exit J2 then 5 min walk) is the most enjoyable option at HKD 88 return. Bus 15 from Exchange Square is cheaper (HKD 10) but misses the funicular experience. Taxi from Central is about HKD 70."
  - question: "Is the Sky Terrace 428 worth the extra cost?"
    answer: "Yes, if visiting for the panorama. Sky Terrace 428 adds HKD 49 to the tram ticket but offers a 360-degree open-air view. The free viewing platform inside the Galleria is also good but more limited."
  - question: "How long does a visit to Victoria Peak take?"
    answer: "Budget 2-3 hours minimum. The Peak Tram ride each way is 8 minutes, viewing takes 30-60 minutes, and the Lugard Road circular walk adds another 45-60 minutes if conditions allow."
  - question: "Is Victoria Peak worth visiting at night?"
    answer: "Absolutely. Hong Kong's illuminated harbour skyline at night is world-famous. Come for sunset and stay for the light show. The neon reflections on the water make for the best photography."
  - question: "What hiking routes are available from Victoria Peak?"
    answer: "Lugard Road (3.5km loop, 45 min, easy) gives continuous views. The Hong Kong Trail Stage 1-2 heads east to Pok Fu Lam. The Peak is also a starting point for trails to Aberdeen through the country park."
  - question: "Are there restaurants at Victoria Peak?"
