...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  { id: 'hong-kong', name: 'Discovering Hong Kong', shortName: 'Hong Kong', domain: 'discoveringhongkong.info', url: 'https://discoveringhongkong.info', flag: '\u{1F1ED}\u{1F1F0}', region: 'east-asia', status: 'live', tagline: 'Neon skylines, dim sum, and dramatic harbour views' },
  // Mexico
...
export const CURRENT_SITE_ID = 'hong-kong';
